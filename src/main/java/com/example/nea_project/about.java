...
public class about {
    ...
    public about(Stage stage, Scene firstScene) {
        this.stage = stage;
    ...
    public void showabout() {
        ...
        Button ReturnButton = createButton("Back to Menu", 10, 10);

        secondGroup.getChildren().addAll(text2, ReturnButton);
        ...
        mainMenu Page02 = new mainMenu(stage);

        ReturnButton.setOnAction(e -> Page02.initialise());
...
//        },3000);
        ...
        }); // creates an event that takes the user back to the main menu when the ESC key is pressed on the keyboard. Serves the same purpose as the button but acts as a means of convenience for the user
    }
